    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form action="<?= base_url('dashboard/products/edit/') . $product->product_id; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input value="<?= $product->product_price ?>" type="text"
                                                class="form-control currency-mask" inputmode="numeric"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img class="profile-user-img img-fluid mb-2"
                                            src="<?= BASE_URL; ?>uploads/products/<?= $product->product_image ?>"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?= $product->brand ?>" type="text" class="form-control"
                                            placeholder="Product Brand" name="brand">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Product Model</label>
                                        <input value="<?= $product->model ?>" type="text" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="unit" id="unit" class="form-control" required>
                                            <option <?= $product->unit === '' ? 'selected' : '' ?> value="">Pick a unit for
                                                the product</option>
                                            <option <?= $product->unit === 'pcs' ? 'selected' : '' ?> value="pcs">Pieces
                                            </option>
                                            <option <?= $product->unit === 'bag' ? 'selected' : '' ?> value="bag">Bag
                                            </option>
                                            <option <?= $product->unit === 'kg' ? 'selected' : '' ?> value="kg">Kilogram
                                            </option>
                                            <option <?= $product->unit === 'carton' ? 'selected' : '' ?> value="carton">
                                                Carton</option>
                                        </select>
                                    </div>
                                </div>
